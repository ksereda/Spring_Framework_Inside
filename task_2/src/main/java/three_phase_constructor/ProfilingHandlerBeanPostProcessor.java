 ...
 *
 * метод getInterfaces() - возвращает только те интерфейсы, которые имплементирует наш класс. Ему не важно, что вы наследуетесь от какого-то другого класса и там тоже есть интерфейсы.
 *
 */
